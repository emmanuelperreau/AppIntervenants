// icons.js — SVG inline pour remplacer Lucide
// Chaque icône retourne un <svg> string avec currentColor.
// Taille définie par width/height en attribut (surchargeable via CSS).

/** @type {Record<string, string>} */
const ICON_PATHS = {
    'phone': '<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.18 2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.69a16 16 0 0 0 6 6l.44-.94a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>',
    ...
    'car': '<path d="M19 17H5v-6l2-4h10l2 4v6Z"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/>',
    ...
    'calendar-clock': '<path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h5"/><circle cx="17.5" cy="17.5" r="4.5"/><path d="M17.5 15v2.5l2 1"/>',
    ...
    'utensils': '<line x1="3" y1="2" x2="3" y2="22"/><path d="M7 2v7a3 3 0 0 0 6 0V2"/><line x1="10" y1="12" x2="10" y2="22"/>',
    'check-circle': '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>',
    'gift': '<polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/>',
    'calendar-days': '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="8.01" y2="14"/><line x1="12" y1="14" x2="12.01" y2="14"/><line x1="16" y1="14" x2="16.01" y2="14"/><line x1="8" y1="18" x2="8.01" y2="18"/><line x1="12" y1="18" x2="12.01" y2="18"/>',
    'phone-call': '<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.18 2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.69a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/><path d="M14.05 2a9 9 0 0 1 8 7.94"/><path d="M14.05 6A5 5 0 0 1 18 10"/>',
    'qr-code': '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="4" y="4" width="5" height="5"/><rect x="15" y="4" width="5" height="5"/><rect x="4" y="15" width="5" height="5"/><path d="M14 14h3"/><path d="M14 18h3"/><path d="M14 21h3"/><path d="M17 14h4v4"/><path d="M17 21h4v-3"/>',
    ...
    'align-start-vertical': '<rect x="6" y="3" width="5" height="18" rx="1"/><rect x="14" y="3" width="4" height="11" rx="1"/><path d="M2 7v2"/><path d="M2 3v2"/>',
    ...
    'ear': '<path d="M6 8.5a6.5 6.5 0 1 1 13 0c0 6-6 6-6 10a3.5 3.5 0 0 1-7 0"/><path d="M15 8.5a2.5 2.5 0 0 0-5 0v1a2 2 0 0 1-2 2"/>',
    'headset': '<path d="M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H3v-7z"/><path d="M21 11h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h3v-7z"/><path d="M21 11V8a9 9 0 0 0-18 0v3"/>',
    ...
    'cigarette-off': '<line x1="2" y1="2" x2="22" y2="22"/><path d="M12 12H2v4h9.24"/><path d="M22 12v4"/><path d="M7 12v4"/><path d="M22 8h-1a5 5 0 0 0-4 2"/><path d="M22 16.73A10 10 0 0 0 17 15"/>',
    ...
    'heart-pulse': '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M3.22 12H9.5l1.5-3 2 4.5 1.5-3 .5 1.5H20.78"/>',
...
/**
 * Génère le SVG HTML pour une icône donnée.
 * @param {string} name - Nom de l'icône (kebab-case)
 * @param {string} [cls=''] - Classes CSS supplémentaires
 * @param {string} [w='24'] - Largeur
 * @param {string} [h='24'] - Hauteur
 * @returns {string} HTML SVG
 */
export function icon(name, cls = '', w = '24', h = '24') {
    const path = ICON_PATHS[name];
    if (!path) {
        console.warn('Icône inconnue :', name);
        return '';
    }
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="${cls}" aria-hidden="true">${path}</svg>`;
}

/**
 * Remplace tous les <i data-lucide="x"> résiduels par du SVG inline.
 * Non utilisé en production (les HTML sont déjà portés), mais gardé
 * comme filet de sécurité.
 */
export function initIcons() {
    document.querySelectorAll('[data-lucide]').forEach(el => {
        const name = el.getAttribute('data-lucide');
        const svgHtml = icon(name || '');
        if (svgHtml) {
            const wrapper = document.createElement('span');
            wrapper.innerHTML = svgHtml;
            const svg = wrapper.firstElementChild;
            if (svg) {
                // Copier classes portées par l'élément <i>
                if (el.className) svg.classList.add(...el.className.split(' ').filter(Boolean));
                el.replaceWith(svg);
            }
        }
    });
